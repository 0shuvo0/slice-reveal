function initSliceReveal(ops) {
    ...
    var addObserver = function (el, close, del) {
    ...
    var removeSlices = function (el) {
        var slices = el.querySelectorAll('.slice-reveal-slice');
    ...
    sliceBgs.forEach(function (el) {
        ...
        var close = el.getAttribute("close-revealed") || false;
